...
class TeacherGradePolicy
{
    ...
    {
        return $user->can('view-any TeacherGrade');
    }
    ...
    {
        return $user->can('view TeacherGrade');
    }
    ...
    {
        return $user->can('create TeacherGrade');
    }
    ...
    {
        return $user->can('update TeacherGrade');
    }
    ...
    {
        return $user->can('delete TeacherGrade');
    }
    ...
    {
        return $user->can('restore TeacherGrade');
    }
    ...
    {
        return $user->can('force-delete TeacherGrade');
    }
}
